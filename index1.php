...
<body>
    ...
    <div class="login-container">
        ...
        <form class="login-form" id="loginForm" method="POST" action="">
            ...
            <p class="signup-link" style="font-size:0.85rem; margin-top: 1rem;">
                New? <a href="signup.php" style="font-weight: 600; color: #6366f1;">Join Now</a> 
                <span style="margin: 0 0.5rem; color: #334155;">|</span>
                <a href="landingpage.php" style="color: #94a3b8; text-decoration: none;">Explore Programs</a>
            </p>
        </form>
    </div>
